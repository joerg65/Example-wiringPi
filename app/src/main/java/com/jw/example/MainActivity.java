...
import static com.jw.wiringpi.wpiAndroid.serialDataAvail;
import static com.jw.wiringpi.wpiAndroid.softPwmCreate;
import static com.jw.wiringpi.wpiAndroid.softPwmWrite;
import static com.jw.wiringpi.wpiAndroid.analogRead;
import static com.jw.wiringpi.wpiAndroid.wiringPiSetup;
import static com.jw.wiringpi.wpiAndroid.openWeatherBoard;
import static com.jw.wiringpi.wpiAndroid.closeWeatherBoard;
import static com.jw.wiringpi.wpiAndroid.getAltitude;
import static com.jw.wiringpi.wpiAndroid.getHumidity;
import static com.jw.wiringpi.wpiAndroid.getPressure;
import static com.jw.wiringpi.wpiAndroid.getTemperature;
import static com.jw.wiringpi.wpiAndroid.getIR;
import static com.jw.wiringpi.wpiAndroid.getUVindex;
import static com.jw.wiringpi.wpiAndroid.getVisible;
import static com.jw.wiringpi.wpiAndroid.readyData;
import static com.jw.wiringpi.wpiAndroid.serialClose;
import static com.jw.wiringpi.wpiAndroid.serialOpen;
import static com.jw.wiringpi.wpiAndroid.serialPuts;
import static com.jw.wiringpi.wpiAndroid.serialGetchar;
...
public class MainActivity extends Activity {
        ...
        public void run() {
            ...
            while (!mStopSerial) {
                ...
                while (serialDataAvail(fd) > 0) {
                    char rec = (char) serialGetchar(fd);
                    if (rec == 13) {
                        Log.i(TAG, "serialGetchar: " + mLine);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((fd = serialOpen("/dev/ttyS1", (int)115200)) < 0)
        {
            Log.e(TAG, "Unable to open serial device") ;
        }
        ...
        mBtn_ReadSerial.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    //setBaudRate();
                    mStopSerial = false;
                    mET_Read.setEnabled(true);
                    new Thread(mRunnableSerial).start();
                } else {
                    mStopSerial = true;
                    mET_Read.setEnabled(false)
